...
const anlagenKonfig = {
  MA: {
    ...
    positionen: [
      { bezeichnung: 'CNC-Fräsmaschine',    nd: 13 },
      { bezeichnung: 'Drehmaschine',         nd: 13 },
      { bezeichnung: 'Schweißanlage',        nd: 10 },
      { bezeichnung: 'Förderanlage',         nd: 13 },
      { bezeichnung: 'Hydraulikpresse',      nd: 10 },
      { bezeichnung: 'Kompressoranlage',     nd: 10 },
    ],
  ...
  FP: {
    ...
    positionen: [
      ...
      { bezeichnung: 'Lieferwagen',          nd:  6 },
      { bezeichnung: 'PKW / Kombi',          nd:  6 },
      { bezeichnung: 'Transporter',          nd:  6 },
      { bezeichnung: 'Anhänger / Auflieger', nd: 10 },
    ],
  ...
  BGA: {
    ...
    positionen: [
      ...
      { bezeichnung: 'Empfangstheke',             nd: 13 },
      { bezeichnung: 'Konferenzraumausstattung',  nd: 13 },
      { bezeichnung: 'Ladeneinrichtung',          nd: 10 },
    ],
